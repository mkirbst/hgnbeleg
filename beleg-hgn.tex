...
Bestand eine IPv4-Adresse aus 4 durch einen Dezimalpunkt getrennten Ziffern mit Werten von jeweils zwischen 0 und 255, also zum Beispiel 85.114.130.113 
...
%\vspace*{1cm}
%%\begin{longtable}{p{34mm}>{\columncolor[gray]{0.97}}p{33mm}p{33mm}>{\columncolor[gray]{0.97}}p{33mm}}\rowcolor[gray]{.9}Funktion & \textbf{IPCop} & \textbf{IPFire} &\textbf{pfSense}\\
\begin{longtable}{p{24mm}>{
	...
	\rowcolor[gray]{.9}\textbf{Adressprefix} & \textbf{Bezeichnung laut IETF} & \textbf{Beschreibung} \\
		::1/128 & Node scoped unicast & sollen nicht im Internet auftauchen\\
		\rowcolor[gray]{.95} ::FFFF:0:0/96 & IPv4 mapped adress & IPv4 gemappte Adresse\\
...
\begin{figure}[htb]
\begin{center}
 \includegraphics[width=1\hsize]{./images/ipv4v6map.png}
 \end{center}
