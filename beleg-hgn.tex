...
\label{sec:1}
Das Internet ist heute überall im täglichen Leben präsent und wird von der UN inzwischen zu den Menschenrechten gezählt.\cite{uninet} Die im Internet heute noch am häufigsten verwendete Protokollfamilie ist IPv4. Wie der Abschnitt \nameref{subsec:1.1} darlegt, ist die weitere Verwendung von IPv4 aber mit immer mehr Problemen behaftet.
...
Der Ziffernbereich umfasst jetzt den Bereich aller Hexadezimalziffern, also 0 bis 9 und A bis F.\footnote{In allen gängigen Betriebssystemen werden IPv4-Adressen durch Dezimalziffern und IPv6-Adressen durch Hexadezimalziffern dargestellt. Prinzipiell unterliegt die Darstellung einer Netzwerkadresse aber keinen Einschränkungen, solange diese eineindeutig ist.} Bis zu vier Hexadezimalziffern werden zu einem Block zusammen gefasst, wobei führende Nullen nicht ausgeschrieben werden m\"ussen. Acht dieser Blöcke, welche durch Doppelpunkte von einander abgegrenzt werden, bilden eine gültige IPv6-Adresse, die vollständig ausgeschrieben  beispielsweise so aussehen kann:  \[ 2001:41d0:0001:f7bb:0000:0000:0000:0001 \]\\
\\
